...
let AuthComponent = class AuthComponent {
    ...
    login() {
        ...
        this.authService.login(Object.assign({}, JSON.parse(localStorage.getItem('user')), this.form.value)).subscribe(answer => {
    ...
    register() {
        this.authService.register(Object.assign({}, this.form.value)).subscribe(user => {
